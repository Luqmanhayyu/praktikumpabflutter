...
class MahasiswaService {
  static final String _baseUrl =
      'http://1.1.1.1/my_mahasiswa/read_mahsiswa.php'; //ganti dengan ip address kalian
  ...
  static final String _url =
      'http://1.1.1.1/my_mahasiswa/create_mahasiswa.php'; //ganti dengan ip address kalian
